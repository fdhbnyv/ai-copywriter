...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#667eea] to-[#764ba2] flex items-center justify-center p-3 sm:p-5">
      <div className="bg-white rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.3)] w-full max-w-4xl overflow-hidden">
        ...
        <div className="p-4 sm:p-8">
          ...
          <div className="mt-4 sm:mt-6 bg-[#f0f7ff] border border-[#cce5ff] rounded-xl p-3 sm:p-4 text-xs sm:text-sm text-[#004085]">
