...
function ImageForm({ setImageUrl, setLoading, prompt, setPrompt, onGenerated }: { setImageUrl: (v: string | null) => void; setLoading: (v: boolean) => void; prompt: string; setPrompt: (v: string) => void; onGenerated: (url: string, prompt: string) => void }) {
  ...
  const sizeOptions = [
    ...
    { v: '1536x1024', l: '1536×1024 (3:2)' },
    { v: '1024x1536', l: '1024×1536 (2:3)' },
    { v: '1824x1024', l: '1824×1024 (16:9)' },
    { v: '1024x1824', l: '1024×1824 (9:16)' },
    { v: '1360x1024', l: '1360×1024 (4:3)' },
    { v: '1024x1360', l: '1024×1360 (3:4)' },
    { v: '2384x1024', l: '2384×1024 (21:9)' },
  ]
  const styleOptions = [
    { v: 'realistic', l: '写实' },
    { v: 'anime', l: '动漫' },
